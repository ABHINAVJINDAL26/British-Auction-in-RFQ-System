        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input required type="email" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} className="w-full bg-bg-elevated border border-border-color rounded-lg px-11 py-2.5 focus:border-accent-blue outline-none text-white transition-all" 
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input required type="password" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} className="w-full bg-bg-elevated border border-border-color rounded-lg px-11 py-2.5 focus:border-accent-blue outline-none text-white transition-all" placeholder="At least 8 characters" />
            </div>
          </div>
